...
|--------------------------------------------------------------------------
|
| What models do we want to cache?
|
*/
$config['api_cache_models'] = array('');
...
|--------------------------------------------------------------------------
|
| Sometimes it is nice to cache our results with Redis. This is where we 
| configure that.
|
*/
$config['api_redis'] = array('enable' => false, 'host' => '127.0.0.1', 'port' => '6379', 'database' => 0);
